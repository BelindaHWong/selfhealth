    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .center, spacing: 20) {
                ...
                let expGoal = Text("I want to find out whether my ") + Text("step count").foregroundColor(.red).bold() + Text(" affects my ") + Text("sleep quality").foregroundColor(green).bold()
...
//                        .foregroundColor(Color.blue) // Set the background color of the button
//                        .frame(height: 60) // Set the height of the button
//
