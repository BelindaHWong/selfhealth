...
//    @State var isDayOne = true
    ...
    var condition: String = "pilates"
    static let shared = HomeView()
    
    var causeOptions = ["Incomplete❓", "Completed ✅"]
    ...
    @State private var people = [
        Person(givenName: "Mon 29/05/23", familyName: "  ✅", emailAddress: " 10,515"),
        Person(givenName: "Tue 30/05/23", familyName: "   ❓", emailAddress: "   3,413"),
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        if(isDayOne) {
                            ...
                            if(condition == "gym") {
                                ...
                                let header = Text("Your steps are classified ") + Text("physically active").foregroundColor(Color(hue: 0.33, saturation: 0.81, brightness: 0.76)).bold() + Text(" on walking days and ") + Text("physically inactive").foregroundColor(Color(hue:0, saturation: 0.81, brightness: 0.76)).bold() + Text(" on walking days.")
                ...
                ZStack {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        if(isChartSelected) {
                            ...
                            if(isDayOne && selectedCause == "Incomplete❓") {
                                if(condition == "gym") {
